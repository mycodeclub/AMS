...
namespace AMS.Controllers
{
    public class BatchesController : Controller
    {
        ...
        {
            //var batches = db.Batches.Include(b => b.TrainingCenter);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BatchId,BatchDurationInDays,StartTime,EndTime,BatchCode")] Batch batch)
        {
            if (ModelState.IsValid)
            {
